"""
Alembic Environment Configuration for COM-AI v3 (MEM-001)
Task ID: MEM-001
...
- UTC timestamps in migration versions
"""
...
from src.api.db.session import get_database_url
...
# Set the SQLAlchemy URL from our session module
